...
#$ -t 1-218 #number of tasks determined based on the number of samples
#total 218 samples

#############################################################################################
#Run KneadData on 218 ILO samples from experimental phase 3, paired-end reads run separately#
#############################################################################################
...
#directory for third batch of samples
...
#may need to edit this based on filename
...
#run paired-end samples together
...
#summary table of how many reads were removed
