...
#$ -N kneaddata_db
#$ -j y
#$ -o /restricted/projectnb/ilometagenomics/data/ILO_combined_cohort/kneaddata_fastq/qsub_logs/
...
#output directory
KNEADDATA_PATH=/restricted/projectnb/ilometagenomics/data/ILO_combined_cohort/kneaddata_fastq
